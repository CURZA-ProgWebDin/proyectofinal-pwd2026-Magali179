...
class Producto(BaseModel):
    ...
    """constructor"""
    def __init__(self, nombre, autor, descripcion, precio_costo, precio_venta, stock_actual, stock_minimo,  categoria_id, proveedor_id):
        self.nombre = nombre
        self.autor = autor
    ...
    def to_dict(self):
        ...
        data.update({
            ...
            'categoria_id': self.categoria.id if self.categoria else None,
